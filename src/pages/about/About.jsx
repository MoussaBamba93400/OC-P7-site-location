...
import KalenImg from '../../assets/kalen.png'
...
const About = () => {
  ...
  return (
    <div className='about-page'>
      <Header />
      <div className="about-banner"><img src={KalenImg} alt="banniere"></img></div>

      <div className="about-collapse" >
      <Collapse className="test" title='Fiabilité' content="Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées  par nos équipes."/>
